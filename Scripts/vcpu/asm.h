...
YY_RULE(int) yy_word(yycontext *yy)
{
  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "word"));
  if (!yymatchRegex(yy, (unsigned char *)"[a-z0-9_]+"))  {
  goto l106;
  }
...
YY_RULE(int) yy_EOF(yycontext *yy)
{
  ...
  goto l114;
  l115:;
  yy->__pos= yypos115; yy->__thunkpos= yythunkpos115;
  }
...
YY_RULE(int) yy_ss(yycontext *yy)
{
  ...
  goto l139;
  l140:;
  yy->__pos= yypos139; yy->__thunkpos= yythunkpos139;
  if (!yymatchChar(yy, '['))  {
  goto l141;
  }
  goto l139;
...
YY_RULE(int) yy_asm(yycontext *yy)
{
  ...
  goto l148;
  l149:;
  yy->__pos= yypos149; yy->__thunkpos= yythunkpos149;
  }
  {
  int yypos150= yy->__pos, yythunkpos150= yy->__thunkpos;
  if (!yy_EOL(yy))   {
  goto l151;
  }
  goto l150;
  l151:;
  yy->__pos= yypos150; yy->__thunkpos= yythunkpos150;
  if (!yy_EOF(yy))   {
  goto l145;
  }
  }
  ...
  goto l144;
  l145:;
  yy->__pos= yypos144; yy->__thunkpos= yythunkpos144;
  if (!yy_something(yy))   {
  goto l143;
  }
