#include "varg.h"
// NOTE, in ARM, ALL general purpose registers are 32 bits in size (uint32_t)
#include "cpu_language.h"
#include "que.h"
#include "stack.h" // the stack is defined as a implimented specific region of memory, located in the RAM, the setup of the stack is complex
#include <string.h>
#include <stdio.h>
#include <inttypes.h>
#include <stdbool.h>
